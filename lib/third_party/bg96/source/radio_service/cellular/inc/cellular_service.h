...
typedef enum
{
    CELLULAR_OK = 0,
    CELLULAR_ERROR,
    CELLULAR_NOT_IMPLEMENTED,
    /* TODO */
    /* return codes like invalid_pin_code, no_sim, not_supported, ...etc... */
} CS_Status_t;
...
typedef struct
{
    ...
    /* CS_CHAR_t                secondary_dns_addr[MAX_SIZE */
...
CS_Status_t CDS_socket_set_option(socket_handle_t sockHandle,
                                  ...
                                  void *p_opt_val);
CS_Status_t CDS_socket_get_option(void); /* TODO */
...
CS_Status_t CDS_socket_listen(socket_handle_t sockHandle /* params TBD */); /* TODO: for socket server mode */
