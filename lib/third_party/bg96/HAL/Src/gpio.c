...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MDM_SIM_SELECT_0_Pin|LED2_Pin|MDM_DTR_Pin, GPIO_PIN_RESET);
  ...
  // Remove the setting for the buttons since are done in AWS AVK
  ...
  GPIO_InitStruct.Pin = MDM_SIM_SELECT_1_Pin|MDM_PWR_EN_Pin;
  ...
  GPIO_InitStruct.Pin = MDM_SIM_SELECT_0_Pin|MDM_RST_Pin|LED2_Pin|MDM_DTR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12 
                          |GPIO_PIN_13|GPIO_PIN_15|GPIO_PIN_3|GPIO_PIN_5 
